...
import { SparklesIcon, MailIcon, CheckCircleIcon, ArrowLeftIcon } from './Home.utils.tsx';


const cssPath = new URL('./Home.css', import.meta.url);
const homeCss = fs.readFileSync(cssPath, 'utf-8');
