...
export function WhatsAppConnectionCard() {
    const [waMethod, setWaMethod] = useState<'qr' | 'phone' | 'wame' | null>(null);
    ...
    return (
        <div class="card wa-web-card">
            ...
            <div class="card-content">
                ...
                {/* Three beautiful connection methods */}
                <div class="wa-methods-grid">
                    <div
                        class={`wa-method-card ${waMethod === 'qr' ? 'active' : ''}`}
                    ...
                    <div
                        class={`wa-method-card ${waMethod === 'phone' ? 'active' : ''}`}
                    ...
                    <div
                        class={`wa-method-card ${waMethod === 'wame' ? 'active' : ''}`}
                        onClick={() => setWaMethod('wame')}
                    >
                        <div class="wa-method-icon">🔗</div>
                        <div class="wa-method-content">
                ...
                {/* Dynamic panels - controlled by selected method */}
                {waMethod === 'qr' && (
                    <div class="wa-panel" id="wa-qr-panel">
                        <div id="wa-web-qr-container" style={{ textAlign: 'center' }}>
                        ...
                        <div id="wa-web-info-box" style={{ margin: '16px 0', padding: '14px', background: 'rgba(245, 158, 11, 0.1)', border: '1px solid rgba(245, 158, 11, 0.3)', borderRadius: '10px', fontSize: '13.5px', color: '#b45309' }}>
                ...
                {waMethod === 'phone' && (
                    <div class="wa-panel" id="wa-phone-panel">
                        ...
                        <div id="wa-pairing-code-display" style={{ textAlign: 'center', margin: '16px 0' }}>
                ...
                {waMethod === 'wame' && (
                    <div class="wa-panel" id="wa-wame-panel" style={{ textAlign: 'center' }}>
