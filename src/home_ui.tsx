...
import { Mail, ArrowLeft, CheckCircle, ShieldCheck, Sparkles } from 'lucide-preact';
            ...
            <body>
                ...
                <div class="landing-card" id="main-card">
                    ...
                    <div id="success-view" style="display:none; text-align:center; padding: 20px 0;">
                        <CheckCircle size={56} color="#22c55e" style="margin-bottom:24px; display:inline-block;" />
