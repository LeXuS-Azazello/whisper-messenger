// Derived from https://github.com/tdlib/td/blob/master/example/web/tdweb/src/index.js
...
export default class TdClient {
    ...
    // Wrap invoke to return a promise
    invoke(query) {
        return new Promise((resolve, reject) => {
            ...
            const handler = (msg) => {
                if (msg['@extra'] === extra) {
                    ...
                    if (msg['@type'] === 'error') {
                        reject(new Error(msg.message || 'TDLib error'));
                    } else {
                        resolve(msg);
                    }
                }
